...
namespace WagglyDBHosting.Controllers
{
    public class PetsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Type,Age,Breed,Owner,Mobile")] Pets pets)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Type,Age,Breed,Owner,Mobile")] Pets pets)
        {
            if (id != pets.Id)
            {
                return NotFound();
